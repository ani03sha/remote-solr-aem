package org.anirudh.redquark.remotesolraem.core.impl;
...
import org.anirudh.redquark.remotesolraem.utils.SolrUtils;
...
@Component
@Service
public class SolrSearchServiceImpl implements org.anirudh.redquark.remotesolraem.core.SolrSearchService {
	...
	public JSONArray crawlContent(String resourcePath, String resourceType) {
		...
		map.put(ResourceResolverFactory.SUBSERVICE, "datasolr");
	...
	/**
	 * This method creates JSONObject which has all the page metadata which is used
	 * to index in Solr server
	 * 
	 * @param It
	 *            takes resource of type cq:PageContent to extract the page metadata
	...
	/**
	 * This method connects to the Solr server and indexes page content using Solrj
	 * api. This is used by bulk update handler (servlet)
	 * 
	 * @param Takes
	...
	/**
	 * This method connects to the Solr server and indexes page content using Solrj
	 * api. This is used by transport handler
	 * 
	 * @param Takes
