...
@Component(label = "AEM Solr Search - Solr Configuration Service", description = "A service for configuring AEM to connect Solr server", immediate = true, metatype = true)
@Service
